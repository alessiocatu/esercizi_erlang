...
%Start with an expression such as the following: ((2+3)-4), 4 and ~((2*3)+(3*4)) which is fully bracketed
...
%which represents ((2+3)-4). We call these exp s.
%Now, write an evaluator, which takes an exp and returns its value.
